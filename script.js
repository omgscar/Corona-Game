...
const rstrt = document.getElementById('rstrt');
...
function createVirus() {
	...
	virus.addEventListener('mouseover',catchVirus);
	virus.addEventListener('mouseover',clik.play());
...
function getRandomLocation() {
	...
	const x = Math.random()*Math.random() * (width - 200) + 100;
